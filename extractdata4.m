...
while i <= length(alldata)
    if alldata(i,3) == 2
        ...
        timesecsprn2(j) = (prn_2_data(j,2)-316800)/60;
    ...
    elseif alldata(i,3) == 5
        ...
        timesecsprn5(j) = (prn_5_data(j,2) - 316800)/60;
    ...
    elseif alldata(i,3) == 6
        ...
        timesecsprn6(j) = (prn_6_data(j,2) - 316800)/60;
    ...
    elseif alldata(i,3) == 10
        ...
        timesecsprn10(j) = (prn_10_data(j,2) - 316800)/60;
    ...
    elseif alldata(i,3) == 12
        ...
        timesecsprn12(j) = (prn_12_data(j,2) - 316800)/60;
...
% xlabel('Time (minutes)')
% title('Carrier Phase Data for L2, Oct. 28, 2015')
...
% plot(timesecsprn2, mp2prn2 - mean(mp2prn2)) % Multipath1 for PRN2
% xlabel('Time (minutes)')
% ylabel('MP2 (m)')
% title('MP2 for PRN 2 - Oct. 28, 2015')
